...
I'm a passionate software developer specializing in blockchain technologies, secure data-sharing platforms, and full-stack web and mobile development.
...
* **Backend:** Java, MongoDB, REST APIs, SQL
* **DevOps:** Docker, Git, GitHub Actions, Linux, Bash scripting
* **AI:** Python, TensorFlow, CNNs
...
### ⚽ Football Badge and Player Recognition

AI chatbot featuring CNN-based image classification for football teams and player identification.
...
* **Technologies:** Java, RSA Encryption, Key Generation and Management
